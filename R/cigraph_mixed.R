cigraphMixed <- function(
  ...
  parallelAngle = pi/6, # Used similarly as parallelAngle in cigraph
  ...
  # Run cigraph:
  invisible(cigraph(Edgelist, parallelEdge  = parallel, parallelAngle = parallelAngle,
