...
EBICglassoCore <- function(
  ...
  countDiagonal = FALSE, # Set to TRUE to get old cigraph behavior: conting diagonal elements as parameters in EBIC computation. This is not correct, but is included to replicate older analyses
...
EBICglasso <- function(
 ...
 EBICglassoCore(S=S, # Sample covariance matrix
                ...
                countDiagonal = countDiagonal, # Set to TRUE to get old cigraph behavior: conting diagonal elements as parameters in EBIC computation. This is not correct, but is included to replicate older analyses
